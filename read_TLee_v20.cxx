...
int main(int argc, char** argv)
{
  ...
  if( 0 ) {
    vector<int>vc_target_chs;
    for(int ibin=1; ibin<=10; ibin++) vc_target_chs.push_back( 11*7+ibin -1 );
  ...
  if( 0 ) {
    if( 1 ) {
      vector<int>vc_target_chs;
      for(int ibin=1; ibin<=25; ibin++) vc_target_chs.push_back( ibin -1 );
    ...
    if( 1 ) {
      ...
      Lee_test->Exe_Goodness_of_fit_detailed( vc_target_chs, vc_support_chs, 103 );
    }
  }
  ...
  if( 0 ) {
    if( 1 ) {
      vector<int>vc_target_chs;
      for(int ibin=1; ibin<=10; ibin++) vc_target_chs.push_back( ibin -1 );
    ...
    if( 1 ) {
      vector<int>vc_target_chs;
      for(int ibin=1; ibin<=10; ibin++) vc_target_chs.push_back( 11+ibin -1 );
  ...
  if( 0 ) {
    if( 1 ) {
      vector<int>vc_target_chs;
      for(int ibin=1; ibin<=8; ibin++) vc_target_chs.push_back( ibin -1 );
    ...
    if( 1 ) {
      vector<int>vc_target_chs;
      for(int ibin=1; ibin<=8; ibin++) vc_target_chs.push_back( 9+ibin -1 );
  ...
  if( 0 ) {
    vector<int>vc_target_chs;
    for(int ibin=1; ibin<=20; ibin++) vc_target_chs.push_back( 6+ibin -1 );
    for(int ibin=1; ibin<=20; ibin++) vc_target_chs.push_back( 26+6+ibin -1 );
    
    vector<int>vc_support_chs;
    for(int ibin=1; ibin<=26*2+11*3; ibin++) vc_support_chs.push_back( 26*2+ibin -1 );
  ...
  if( 0 ) {
    ...
    for(int ibin=1; ibin<=20; ibin++) vc_target_chs.push_back( 6+ibin -1 );
    for(int ibin=1; ibin<=20; ibin++) vc_target_chs.push_back( 26+6+ibin -1 );    
    for(int ibin=1; ibin<=26*2+11*3; ibin++) vc_target_chs.push_back( 26*2+ibin -1 );
