...
{  
  ...
  double data_dchi2_LEE2GMIN = 5.1594;
  double data_dchi2_SM2GMIN  = 3.3346;
  
  TString roostr = "";
  roostr = "./result_open_nearfar/file_exLEE_exSM.root";
  ...
  for(int ientry=0; ientry<entries; ientry++) {
    ...
    if( dchi2_LEE2GMIN<0 && fabs(dchi2_LEE2GMIN)<1e-6 ) dchi2_LEE2GMIN = 0;
    vc_dchi2_LEE2GMIN.push_back( dchi2_LEE2GMIN );
    
    double dchi2_SM2GMIN = chi2_null_null8sm_true8sm - chi2_gmin_null8sm_true8sm;
    if( dchi2_SM2GMIN<0 && fabs(dchi2_SM2GMIN)<1e-6 ) dchi2_SM2GMIN = 0;
  ...
  TH1D *h1_pdf_dchi2_LEE2GMIN = new TH1D("dchi2_LEE2GMIN", "", 100, 0, 20);
  ...
  pt_LEE2GMIN->AddText( Form("#rightarrow p-value = %5.3f", pvalue_LEE2GMIN) );
  ...
  pt_cdf_LEE2GMIN->AddText( Form("#rightarrow p-value = %5.3f", pvalue_LEE2GMIN) );
  ...
  TH1D *h1_pdf_dchi2_SM2GMIN = new TH1D("dchi2_SM2GMIN", "", 100, 0, 20);
