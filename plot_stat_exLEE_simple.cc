...
{  
  ...
  double data_dchi2_LEE2GMIN = 4.7481;
  double data_dchi2_LEE2SM   = data_dchi2_LEE2GMIN;
  
  TString roostr = "";
  roostr = "./result_opendata5e19/file_exLEE_simple.root";
  ...
  TH1D *h1_pdf_dchi2_LEE2SM = new TH1D("dchi2_LEE2SM", "", 100, -25, 25);
